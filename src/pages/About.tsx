      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Target, title: "Our Mission", desc: "To provide accessible, quality education that empowers students to achieve their full potential." },
              { icon: Lightbulb, title: "Our Approach", desc: "Combining theoretical knowledge with practical skills for holistic development." },
              { icon: Users, title: "Our Community", desc: "Building a supportive learning environment for students from all backgrounds." },
              { icon: Award, title: "Our Standards", desc: "Maintaining excellence through recognized certifications and industry partnerships." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
